...
namespace MyFillet
{
    public class MyFillet
    {
        ...
        // 2개 선 fillet
        public (Line, Line) Fillet(Line line1, Line line2)
        {
            double slope1 = (line1.StartPoint.Y - line1.EndPoint.Y) / (line1.StartPoint.X - line1.EndPoint.X);
            double slope2 = (line2.StartPoint.Y - line2.EndPoint.Y) / (line2.StartPoint.X - line2.EndPoint.X);
        ...
        public void Command()
        {
            ...
            while (true)
            {
                using (Transaction transaction = db.TransactionManager.StartTransaction())
                {
                    ...
                    selFirstLine.SetRejectMessage("잘못 선택했습니다.");
                    ...
                    selSecondLine.SetRejectMessage("잘못 선택했습니다.");
                    ...
                    (Line line1, Line line2) = Fillet(FirstLine, SecondLine);
                    FirstLine.Erase();
                    SecondLine.Erase();
